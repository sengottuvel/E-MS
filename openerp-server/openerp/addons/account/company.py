...
# EntryInfo
		'us_id': fields.many2one('res.users', 'Created By', readonly=True),
		'approve_date': fields.datetime('Approved Date', readonly=True),
		'app_user_id': fields.many2one('res.users', 'Approved By', readonly=True),
		'reject_date': fields.datetime('Edited Date', readonly=True),
		'rej_user_id': fields.many2one('res.users', 'Edited By', readonly=True),
    ...
    _defaults = {
		'us_id': lambda obj, cr, uid, context: uid,    
