...
class mrp_bom(osv.osv):
    ...
    _columns = {
        ...
        'product_id': fields.many2one('product.product', 'Product', required=True,domain=[('state','=','approved'),('categ_id','=','Finished goods')]),
        ...
        'product_uom': fields.many2one('product.uom', 'Product UOM', required=True, help="Unit of Measure (Unit of Measure) is the unit of measurement for the inventory control"),
		...
		'source_bom': fields.many2one('mrp.bom', 'Source BOM',domain="[('state','=','approved'), ('active','=','t')]"),
		'copy_flag':fields.boolean('Copy Flag'),
		'name_b': fields.char('BOM Name', size=128, required=True, select=True),
	#newly added
